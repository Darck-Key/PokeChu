const TOURS_DATA = [
  {
    ...
    gallery: ["assets/images/tours/placeholder.png","assets/images/tours/placeholder.png"],
    thumb: "assets/images/tours/placeholder.png",
  ...
  },
  {
    ...
    gallery: ["assets/images/tours/placeholder.png"],
    thumb: "assets/images/tours/placeholder.png",
...
function renderTourDetail(t) {
  ...
  const mapImgEl = el('#tourMapImg');
  if (mapImgEl) {
    mapImgEl.src = t.mapImg || 'assets/images/regions/placeholder.png';
    mapImgEl.alt = `Mapa de ${t.region || 'la tour'}`;
  }
